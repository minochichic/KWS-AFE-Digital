...
| `bd_base`, **균형 세트** (`selftest_bal` 0–599, 12 클래스 × 50) | ✅ **PASS** | **600 / 600 일치 × 2 회**, 57.5 ms/클립, 정확도 0.833 (2026-09-17 20:59) |
| `bd_base_ft20_partial75`, **균형 세트** (`selftest_bal` 0–599) | ✅ **PASS** | **600 / 600 일치 × 2 회**, 57.5 ms/클립, 정확도 0.835 (2026-09-17 22:45) |
