...
최악 채널의 4.0 mV가 비교기 오프셋(~1 mV)과 채널별 정지점 산포(~±2.4 mV, 아래 3-2)를
합한 것보다 크다. **여유는 1.18배로 넉넉하지 않으니, 보드가 나오면 여기를 먼저 잰다.**
산포가 예상보다 크게 나오면 그때 δ를 조금 올린다 (학습에서 δ를 0→0.4%로 올려도
정확도는 0.8 SE 안이라, 올릴 여지는 있다).
